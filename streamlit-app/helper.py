...
def query_point_creator_lstm(q1,q2,myvectorizer):
    ...
    input_ques.append(q1)
    input_ques.append(q2)

    res1,res2=np.vsplit(myvectorizer(input_ques).numpy(),2)

    return res1,res2,np.array(input_query).reshape(1,15)
